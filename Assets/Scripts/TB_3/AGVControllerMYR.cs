...
{
    public enum ControlModeMYR { Keyboard, ROS};

    public class AGVControllerMYR : MonoBehaviour
    {
        ...
        void Start()
        {
            // Debug.Log("************Running Start**********"+ gameObject.name);
            ...
            // Debug.Log("ASM: "+ ros);
            ros.Subscribe<TwistMsg>("tb3_0/cmd_vel", ReceiveROSCmd);
        }

        // void OnDestroy(){
        //     // Destroy(ROSConnection.GetOrCreateInstance());
        //     // ros.Unsubscribe("tb3_0/cmd_vel");
        //     // ros.Disconnect();
