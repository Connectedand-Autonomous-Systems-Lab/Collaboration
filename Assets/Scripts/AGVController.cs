...
namespace RosSharp.Control
{
    ...
    public class AGVController : MonoBehaviour
    {
        ...
        private void ROSUpdate()
        {
            ...
            // Debug.Log($"rosLinear: {rosLinear}    angular: {rosAngular}");
            RobotInput(rosLinear, -rosAngular);
        }

        private void RobotInput(float speed, float rotSpeed) // m/s and rad/s
        {
            // Debug.Log($"rot speed {rotSpeed}   max rot speed {maxRotationalSpeed}");
            ...
            if (rotSpeed != 0)
            {
                wheel1Rotation = (wheel1Rotation + (wheelSpeedDiff / 1)) * Mathf.Rad2Deg*10;
                wheel2Rotation = (wheel2Rotation - (wheelSpeedDiff / 1)) * Mathf.Rad2Deg*10;
            }
            else
            {
            ...
            // Debug.Log($"right: {wheel1Rotation}  left:{wheel2Rotation}");
        }
    }
}
